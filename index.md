...
<body>
  <div class="main-content">
    ...
    <p style="color: #000;">I am seeking a Ph.D. position in Linguistics or Computational Linguistics. Here, I share information about my academic journey.</p>
...
<ul style="list-style: none;">
  ...
  <li><strong>&#8226; Programming Languages</strong>
    <ul style="list-style-type: none; padding-left: 0;">
      <li style="margin-bottom: 5px;">&#9702;Python (Natural Language Processing (NLP) tasks with nltk and spaCy, including word frequency, concordancing, part-of-speech tagging, morphosyntactic features, synonym set, and basic use of regex and pandas) </li>
